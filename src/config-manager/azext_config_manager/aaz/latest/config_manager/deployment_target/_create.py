...
class Create(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.edge/deploymenttargets/{}", "2024-08-01-preview"],
        ]
    }
    ...
    class DeploymentTargetsCreateOrUpdate(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.Edge/deploymentTargets/{deploymentTargetName}",
                **self.url_parameters
            )
