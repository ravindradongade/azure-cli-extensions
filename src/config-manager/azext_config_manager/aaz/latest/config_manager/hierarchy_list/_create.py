...
class Create(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.HierarchyListsCreateOrUpdate(ctx=self.ctx)()
    ...
    class HierarchyListsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            hierarchy_levels = cls._schema_on_200_201.properties.hierarchy_levels
            hierarchy_levels.Element = AAZObjectType()

            _element = cls._schema_on_200_201.properties.hierarchy_levels.Element
