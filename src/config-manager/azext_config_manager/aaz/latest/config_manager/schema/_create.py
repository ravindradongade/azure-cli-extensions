...
class Create(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/schemas/{}",
             "2024-08-01-preview"],
        ]
    }
    ...
    class SchemasVersionCreateOrUpdate(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/schemas/{schemaName}/versions/{version}",
                **self.url_parameters
            )
        ...
        def content(self):
            ...
            properties = _builder.get(".properties")
            if properties is not None:
                properties.set_prop("value", AAZStrType, ".schema_file", typ_kwargs={"flags": {"required": True}})
