...
@register_command(
    "config-manager solution list",
    is_preview=True,
)
class List(AAZCommand):
    """List Solutions by specified resource group or subscription
    """
    ...
    class SolutionsListByResourceGroup(AAZHttpOperation):
        ...
        def url(self):
            if has_value(self.ctx.args.resource_group) and has_value(self.ctx.subscription_id):
                return self.client.format_url(
                    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/solutions",
                    **self.url_parameters
                )
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/Microsoft.Edge/solutions",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            configuration_links = cls._schema_on_200.value.Element.properties.configuration_links
            configuration_links.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.configuration_links.Element
