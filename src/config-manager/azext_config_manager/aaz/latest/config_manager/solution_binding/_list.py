...
@register_command(
    "config-manager solution-binding list",
    is_preview=True,
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SolutionBindingsListByResourceGroup(ctx=self.ctx)()
    ...
    class SolutionBindingsListByResourceGroup(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.Edge/solutionBindings",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            configured_solution_versions = cls._schema_on_200.value.Element.properties.configured_solution_versions
            configured_solution_versions.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.configured_solution_versions.Element
